  ...
  return (
    <section className="xms-card flex flex-col gap-3 p-4" aria-label="Subscribe to this calendar">
      <div>
        ...
        <p className="text-xms-body mt-2 text-body">
      ...
      {url ? (
        <div className="flex flex-col gap-2">
          <label className="text-xms-label text-body" htmlFor="calendar-feed-url">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <input
              ...
              className="border-xms-control-line bg-xms-card xms-mono h-[var(--xms-control-h)] min-w-0 flex-1 rounded-control border px-3 text-body"
            />
            <button
              type="button"
