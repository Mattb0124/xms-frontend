  ...
  return (
    ...
    >
      <div className="flex items-center gap-[14px]">
        ...
        <span className="xms-mono bg-xms-chip text-xms-body shrink-0 rounded-pill px-[11px] py-[6px] text-[14px] leading-none font-medium">
          {props.age}
        </span>
      </div>
      <div className="mt-3 flex flex-wrap items-center gap-[10px]">
        ...
        {props.suggestion ? (
          ...
          <button
            ...
            data-suggestion
            className="border-xms-note-line bg-xms-note-bg text-xms-body hover:bg-xms-control-hover-border rounded-pill border px-[13px] py-2 text-[14px] font-medium whitespace-nowrap"
          >
        ...
        <button
          ...
          className="border-xms-accent-border bg-xms-card text-xms-accent hover:bg-xms-accent-tint rounded-control border px-[14px] py-[10px] text-[14px] font-medium whitespace-nowrap"
        >
          Assign to me
        </button>
        <button
          ...
          className="bg-xms-accent hover:bg-xms-accent-hover rounded-control px-4 py-[10px] text-[14px] font-semibold whitespace-nowrap text-white"
        >
          Confirm
        </button>
      </div>
