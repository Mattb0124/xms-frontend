...
const STACK_LABEL = "text-xms-muted text-body leading-[1.3]";
    ...
    <div className={STACK_ROW} data-field={label.toLowerCase()}>
      ...
      {editing && !disabled ? (
        ...
        <button
          ...
          aria-label={label}
          className={cn(
            "hover:bg-xms-row-hover -mx-1 rounded-control px-1 py-[1px] text-left text-body leading-[1.4] font-medium",
          ...
          field.second ? (
            ...
            <div key={field.key} className={STACK_ROW} data-field={field.key}>
              ...
              <span className="flex flex-wrap items-baseline gap-[6px]">
                ...
                <span className="text-xms-muted text-body">{"·"}</span>
