...
export function AddFilterButton({ onClick, className }: AddFilterButtonProps) {
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "border-xms-quiet-line bg-xms-card text-xms-body hover:bg-xms-control-hover hover:text-xms-accent inline-flex h-[var(--xms-header-pill-h)] shrink-0 items-center gap-[6px] rounded-control border border-dashed px-[11px] text-body font-medium whitespace-nowrap",
        className,
      )}
    >
