...
function PayloadCell({ payload }: { payload: Record<string, unknown> }) {
  return (
    <details className="text-body">
      ...
      <pre className="xms-mono text-xms-body mt-1 max-h-[200px] max-w-[480px] overflow-auto text-body whitespace-pre-wrap">
...
export function DeadLettersTab({ instanceId }: { instanceId: string }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      >
        <summary className="text-xms-ink cursor-pointer text-body font-medium">Resolved dead letters</summary>
        {showResolved ? (
          <div className="mt-3">
            <DenseTable
              title="Resolved"
