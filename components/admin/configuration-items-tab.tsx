  ...
  const columns = useMemo<DenseColumn<ConfigurationItem>[]>(
    () => [
      ...
      },
      {
        ...
        render: (row) =>
          row.external_ref ? (
            <span className="xms-mono text-xms-body text-body">{row.external_ref}</span>
          ) : (
    ...
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap items-center gap-2">
        <input
          ...
          className="border-xms-control-line bg-xms-card h-[var(--xms-control-h)] w-[260px] rounded-control border px-3 text-body"
        />
        <select
          aria-label="Kind"
          value={type}
          onChange={(event) => setType(event.target.value)}
          className="border-xms-control-line bg-xms-card h-[var(--xms-control-h)] rounded-control border px-3 text-body"
        >
        ...
        >
          <label className="flex flex-col gap-1 text-body">
            ...
            <input
              ...
              className="border-xms-control-line bg-xms-card h-[var(--xms-control-h)] w-[280px] rounded-control border px-3 text-body"
            />
          </label>
          <label className="flex flex-col gap-1 text-body">
