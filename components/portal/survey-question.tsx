          ...
          <div className="grid grid-cols-5 gap-2">
            {SCORES.map((value) => (
              <button
                ...
                data-score={value}
                className={cn(
                  "border-xms-line text-xms-body hover:bg-xms-control-hover flex min-h-[64px] flex-col items-center justify-center gap-1 rounded-card border px-1 py-2 outline-none",
