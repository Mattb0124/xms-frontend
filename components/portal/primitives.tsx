...
export const PORTAL_PRIMARY =
  "bg-xms-accent hover:bg-xms-accent-hover inline-flex h-[40px] items-center justify-center rounded-card px-4 text-[14px] font-medium text-white outline-none disabled:opacity-50";
export const PORTAL_SECONDARY =
  "border-xms-line text-xms-body hover:bg-xms-control-hover inline-flex h-[40px] items-center justify-center rounded-card border px-4 text-[14px] outline-none disabled:opacity-50";
export const PORTAL_DANGER =
  "border-[color:var(--state-overdue-border)] text-[color:var(--state-overdue-text)] inline-flex h-[40px] items-center justify-center rounded-card border px-4 text-[14px] outline-none disabled:opacity-50";
export const PORTAL_INPUT =
  "border-xms-line bg-xms-card text-xms-ink h-[40px] w-full rounded-card border px-3 text-[14px] outline-none disabled:opacity-60";
export const PORTAL_TEXTAREA =
  "border-xms-line bg-xms-card text-xms-ink w-full rounded-card border p-3 text-[14px] outline-none disabled:opacity-60";
