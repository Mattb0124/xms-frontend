...
const CONTROL =
  "border-xms-line bg-xms-card text-xms-ink w-full rounded-control border px-2 py-2 text-body outline-none disabled:opacity-60";
...
function SectionField({
  ...
  return (
    <div className="flex flex-col gap-1" data-section={section}>
      <label htmlFor={id} className="text-xms-ink text-body font-semibold">
        {SECTION_LABEL[section]}
      </label>
      {SECTION_HINT[section] ? <p className="text-xms-label text-body">{SECTION_HINT[section]}</p> : null}
      <textarea
        id={id}
