...
const CHIP =
  "border-xms-line bg-xms-tint text-xms-body inline-flex h-[22px] items-center gap-1 rounded-pill border px-2 text-body whitespace-nowrap";
  ...
  const columns: DenseColumn<Person>[] = [
    {
      ...
      render: (row) => (
        <span className="xms-stack">
          ...
          <span className="xms-mono text-xms-label text-body">{row.email}</span>
        </span>
      ),
    },
