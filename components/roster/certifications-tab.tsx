  ...
  return (
    <div className="grid gap-4 lg:grid-cols-[1fr_360px]">
      <Panel title="Certifications" caption="Expiry within 90 days shows amber; past expiry shows red">
        {certifications.length === 0 ? <p className="text-xms-label text-body">No certifications recorded.</p> : null}
          ...
          {certifications.map((certification) => (
            ...
            >
              <span className="flex min-w-[220px] flex-col">
                ...
                {certification.issuer ? <span className="text-xms-label text-body">{certification.issuer}</span> : null}
              </span>
