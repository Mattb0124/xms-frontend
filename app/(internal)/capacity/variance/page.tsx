...
const HEAD = "text-xms-ink px-[14px] py-[11px] text-left text-body font-semibold whitespace-nowrap";
      ...
      <div className="flex flex-col gap-4">
        ...
        {report.data ? (
          <Panel
            ...
            flush
          >
            <table className="w-full border-collapse text-body" aria-label="Planned versus actual">
              ...
              <tfoot>
                <tr className="text-xms-ink text-body font-semibold" data-testid="variance-totals">
