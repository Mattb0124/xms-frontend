      ...
      >
        ...
        <div className="flex flex-col gap-3">
          <fieldset className="border-xms-line rounded-control border p-3">
            ...
            {(roles.data ?? []).map((role) => (
              <label key={role.id} className="flex items-center gap-2 py-1 text-body">
                <input
                  type="checkbox"
          ...
          <fieldset className="border-xms-line rounded-control border p-3">
            ...
            {(accounts.data ?? []).map((account) => (
              <label key={account.id} className="flex items-center gap-2 py-1 text-body">
                <input
                  type="checkbox"
            ...
            {(accounts.data ?? []).length === 0 ? <p className="text-xms-label text-body">No accounts yet.</p> : null}
          </fieldset>
        </div>
