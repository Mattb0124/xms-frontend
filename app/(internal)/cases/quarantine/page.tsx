  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3">
        ...
        <pre className="text-xms-body bg-xms-tint max-h-[320px] overflow-auto rounded-card p-3 text-body whitespace-pre-wrap">
        ...
        <button type="button" onClick={onClose} className="text-xms-label self-start text-body hover:underline">
          Close
        </button>
      </div>
    </Panel>
