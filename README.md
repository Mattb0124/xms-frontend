...
- Admin: accounts (settings, intake aliases, AI section, calendars, contracts with the rules editor (after-hours handling, overage, rollover, thresholds, client notification, forecast window, required technology codes) and rate card versions per contract and as the account default,
