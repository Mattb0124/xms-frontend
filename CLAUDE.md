...
## Layout (as built 2026-09-07, capacity and billing cut with the skills matrix and forward demand, then CSAT and report schedules, per ADR-14)
...
redux/                  api.ts (base API, me endpoint), adminApi.ts (Accounts & Administration endpoints and types, plus
                        ...
                        and ReportRuns tags, knowledgeApi.ts (articles, drafts, publish, retire, generalize,
